...
import DeleteAlert from '../../component/layouts/DeleteAlert';
import { useUserAuth } from '../../hooks/useUserAuth';
import { toast } from 'react-hot-toast';

const Income = () => {
  useUserAuth();//checks for authetication
  ...
  const handleDownloadIncomeDetails = async () => {
    try {
      ...
      toast.error("Failed to download income details. Please try later.");
    }
  };
